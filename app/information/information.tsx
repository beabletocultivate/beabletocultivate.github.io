            ...
            <div className="relative z-10 page-container">
                ...
                <div className="text-center mb-10">
                    <div className="jp-badge mb-3">
                        <span>✦</span>
                        <span>INFORMATION // 開催概要</span>
                        <span>✦</span>
                    </div>
                    <h1 className="text-5xl md:text-7xl font-title tracking-tight text-gradient-sunset drop-shadow mb-2">
                        {strings.information}
                    </h1>
                    <p className="text-sm font-maru text-primary-variant/80">
                    ...
                    <div className="w-full lg:w-1/2 glass-panel rounded-3xl p-6 md:p-8 flex flex-col justify-between gap-6 border border-white/10 shadow-2xl">
                        ...
                        <div className="flex flex-col gap-1.5 font-maru">
                            <div className="flex items-center gap-2 text-primary-variant font-bold text-sm tracking-wider uppercase">
                                <span>📅</span>
                                <span>{strings.eventDateTitle} // 日時</span>
                            </div>
                            ...
                            <div className="mt-2">
                                ...
                                >
                                    <span>➕</span>
                                    <span>{strings.eventAddToCalendar}（Google カレンダー）</span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-1.5 font-maru">
                            <div className="flex items-center gap-2 text-primary-variant font-bold text-sm tracking-wider uppercase">
                                <span>📍</span>
                                <span>{strings.eventVenueTitle} // 会場</span>
                            </div>
                        ...
                        <div className="flex flex-col gap-2 font-maru">
                            <div className="flex items-center gap-2 text-primary-variant font-bold text-sm tracking-wider uppercase">
                                <span>🎟️</span>
                                <span>{strings.eventTicketTitle} // チケット</span>
                            </div>
                            <div className="flex items-baseline gap-3">
                                <span className="text-3xl font-extrabold text-gradient-gold">
                                    {strings.eventTicketPrice}
                                </span>
                                <span className="text-xs text-text-muted">/ 入場券（ドリンク別）</span>
                            </div>
                            <div className="mt-3">
                                <a
                                ...
                                >
                                    <span>{strings.eventBuyTickets}（チケット予約）</span>
                                    <span>→</span>
                                </a>
                            </div>
                        </div>
